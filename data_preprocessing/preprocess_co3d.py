...
CO3D_RAW_ROOT = "/storage/user/sade/co3d/DOWNLOAD_FOLDER" # change to where your CO3D data resides
CO3D_OUT_ROOT = "/storage/user/sade/co3d_out" # change to your folder here
